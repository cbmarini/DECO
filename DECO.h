...
#do i=1,1
        id, once charSU2(rep?{>3},n?) = sum_(jj,-(rep-1),rep-1,2,y^(jj*n));
        if ( match(charSU2(rep?{>3},n?)) ) redefine i "0";
        .sort
#enddo
...
#do i=1,1
        id, once charSU3(B6,n?) = z1^(-2*n)+z1^n+z1^(2*n)/z2^(2*n)+z2^(-n)+z2^n/z1^n+z2^(2*n);
...
#do i=1,1
        id, once charSU3(B10,n?) = 1+z1^(-3*n)+z1^(3*n)/z2^(3*n)+z1^n/z2^(2*n)+1/(z1^n*z2^n)+z1^(2*n)/z2^n+z2^n/z1^(2*n)+z1^n*z2^n+z2^(2*n)/z1^n+z2^(3*n);
...
#do i=1,1
        id, once charSU3(B15,n?) = 2/z1^n+z1^(2*n)+z1^(2*n)/z2^(3*n)+z2^(-2*n)+z1^(3*n)/z2^(2*n)+1/(z1^(2*n)*z2^n)+(2*z1^n)/z2^n+2*z2^n+z2^n/z1^(3*n)+z2^(2*n)/z1^(2*n)+z1^n*z2^(2*n)+z2^(3*n)/z1^n;
...
#do i=1,1
        id, once charSU3(B28,n?) = 1+z1^(-6*n)+z1^(-3*n)+z1^(3*n)+z1^(6*n)/z2^(6*n)+z1^(4*n)/z2^(5*n)+z1^(2*n)/z2^(4*n)+z1^(5*n)/z2^(4*n)+z2^(-3*n)+z1^(3*n)/z2^(3*n)+1/(z1^(2*n)*z2^(2*n))+z1^n/z2^(2*n)+z1^(4*n)/z2^(2*n)+1/(z1^(4*n)*z2^n)+1/(z1^n*z2^n)+z1^(2*n)/z2^n+z2^n/z1^(5*n)+z2^n/z1^(2*n)+z1^n*z2^n+z2^(2*n)/z1^(4*n)+z2^(2*n)/z1^n+z1^(2*n)*z2^(2*n)+z2^(3*n)+z2^(3*n)/z1^(3*n)+z2^(4*n)/z1^(2*n)+z1^n*z2^(4*n)+z2^(5*n)/z1^n+z2^(6*n);
